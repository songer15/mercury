...
public class ExecutorReport extends AbstractPrintable{
    ...
    public ExecutorReport(String clientName, String clientPsd, String instanceStatus, Date actionTime, Long instanceID, String errorMessage) {
        this.clientName = clientName;
        this.clientPsd = clientPsd;
        this.instanceStatus = instanceStatus;
        this.actionTime = actionTime;
    ...
    public void setEndTime() {
        if (metrics != null)
            metrics.put("endTime", System.currentTimeMillis());
    }
