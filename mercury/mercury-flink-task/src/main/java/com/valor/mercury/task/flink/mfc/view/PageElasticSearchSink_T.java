 ...
 * 2019/9/26 11:24
 */
public class PageElasticSearchSink_T implements ElasticsearchSinkFunction<Row>, Serializable {
    private String index;

    public PageElasticSearchSink_T(String index) {
        super();
        this.index = index;
    }
    ...
    private IndexRequest createIndexRequest(Row element) {
        ...
        json.put("aggregationType", "PageAction_Count");
