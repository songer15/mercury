 ...
 * 2019/9/26 11:24
 */
public class PlayElasticSearchSink_P implements ElasticsearchSinkFunction<Row>, Serializable {
    private String index;

    public PlayElasticSearchSink_P(String index) {
        super();
        this.index = index;
    }
    ...
    private IndexRequest createIndexRequest(Row element) {
        ...
        json.put("vendorId", element.getField(7));
        json.put("LocalCreateTime", new Date());
        json.put("aggregationType", "PlayAction_Unique");
