...
import com.valor.mercury.gateway.elasticsearch.query.join.HashJoinElasticRequestBuilder;
import com.valor.mercury.gateway.elasticsearch.query.join.TableInJoinRequestBuilder;
...
public class HashJoinElasticExecutor extends ElasticJoinExecutor {
    ...
    private List<SearchHit> createCombinedResults( TableInJoinRequestBuilder secondTableRequest) {
        ...
        //根据sql hint限制，或默认 MAX_RESULTS_ON_ONE_FETCH（10000） 按照scroll查询。
